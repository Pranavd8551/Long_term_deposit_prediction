...
from long_term_deposit_prediction.utils.main_utils import load_numpy_array_data, load_object, save_object
from long_term_deposit_prediction.entity.config_entity import ModelTrainerConfig
from long_term_deposit_prediction.entity.artifact_entity import DataTransformationArtifact, ModelTrainerArtifact, ClassificationMetricArtifact
...
class ModelTrainer:
    ...
    def initiate_model_trainer(self) -> ModelTrainerArtifact:
        ...
        try:
            ...
            deposit_model = DepositModel(preprocessing_object=preprocessing_obj, trained_model_object=best_model)
            save_object(self.model_trainer_config.trained_model_file_path, deposit_model)
